...
const MESSAGES = Object.freeze({
  ...
  tune: { dir: Dir.C2S, feature: 'rig', fields: { frequency: f.number, mode: f.optString } },
  ...
  // ─── KiwiSDR / WebSDR ───────────────────────────────────────────────
  'kiwi-connect': { dir: Dir.C2S, feature: 'kiwi', fields: { host: f.string } },
  'kiwi-disconnect': { dir: Dir.C2S, feature: 'kiwi' },

  // ─── Voice macros / preferences / decorations ───────────────────────
  'voice-macro-sync': { dir: Dir.C2S, feature: 'misc' },
