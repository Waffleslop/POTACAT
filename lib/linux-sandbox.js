...
//
// ENFORCEMENT NOTE: this module is the unit-tested SPEC, not the
// enforcement point. Chromium aborts before main.js runs in the failing
// configurations (CI-proven: startup.log never created, so
// app.commandLine.appendSwitch was useless), so the live decision is
// implemented in POSIX sh in scripts/linux-launcher.sh, installed as
// the packaged entry point by scripts/linux-after-pack.js. If you
// change the matrix here, change the launcher to match — and vice
// versa. main.js only LOGS the active fallback to startup.log.
