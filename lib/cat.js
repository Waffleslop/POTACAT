...
class CatClient extends EventEmitter {
  ...
  sendCwText(text) {
    ...
    if (this._isYaesu()) {
      // Yaesu KY command: KY<P1> <text padded to 48 chars>;
      // P1 meaning varies by model:
      //   FT-991A, FT-710, FTDX10: P1=0(Main VFO), P1=1(Sub VFO)
      //   FTDX101D/MP: P1=0(Read status), P1=1(Send text)
