...
const RIGCTLD_LEVEL_KINDS = { STRENGTH: 'smeter', SWR: 'swr', ALC: 'alc', RF: 'rfgain', RFPOWER: 'rfpower', PREAMP: 'preamp', ATT: 'att' };
const RIGCTLD_FUNC_KINDS = { NB: 'nb', NR: 'nr', COMP: 'comp', VOX: 'vox', ANF: 'anf', TUNER: 'tuner' };
...
class RigctldCodec extends EventEmitter {
  ...
  getDnrLevel() { this._getExt('nr', 'u NR\n'); }        // emits 'nr' on/off
