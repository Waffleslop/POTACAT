...
struct OFDM {
  ...
  cf_complex *pilot_samples;
  cf_complex *rxbuf;
  cf_complex *pilots;
  cf_complex **rx_sym;
  cf_complex *rx_np;
  cf_complex *tx_uw_syms;
  COMP *tx_preamble;
  COMP *tx_postamble;
...
cf_complex qpsk_mod(int *);
cf_complex qam16_mod(int *);
void qpsk_demod(cf_complex, int *);
void qam16_demod(cf_complex, int *);
void ofdm_txframe(struct OFDM *, cf_complex *, cf_complex[]);
void ofdm_assemble_qpsk_modem_packet(struct OFDM *, uint8_t[], uint8_t[],
                                     uint8_t[]);
void ofdm_assemble_qpsk_modem_packet_symbols(struct OFDM *, cf_complex[],
                                             COMP[], uint8_t[]);
void ofdm_disassemble_qpsk_modem_packet(struct OFDM *, cf_complex rx_syms[],
