...
/*  int order 		order of the polynomial 			*/
{
  ...
  float *t, *u, *v, sum;
  #ifdef _MSC_VER
  float *T = (float *)_alloca(((order / 2) + 1) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *T = (float *)_alloca(((order / 2) + 1) * sizeof(float));
  #else
...
/*  float delta			grid spacing interval (0.02) 		*/
{
  ...
  #ifdef _MSC_VER
  float *Q = (float *)_alloca((order + 1) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *Q = (float *)_alloca((order + 1) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *P = (float *)_alloca((order + 1) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *P = (float *)_alloca((order + 1) * sizeof(float));
  #else
...

{
  ...
  #ifdef _MSC_VER
  float *freq = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *freq = (float *)_alloca((order) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *Wp = (float *)_alloca(((order * 4) + 2) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *Wp = (float *)_alloca(((order * 4) + 2) * sizeof(float));
  #else
