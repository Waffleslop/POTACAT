...
void encode_lspds_scalar(int indexes[], float lsp[], int order) {
  int i, k, m;
  #ifdef _MSC_VER
  float *lsp_hz = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *lsp_hz = (float *)_alloca((order) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *lsp__hz = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *lsp__hz = (float *)_alloca((order) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *dlsp = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *dlsp = (float *)_alloca((order) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *dlsp_ = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *dlsp_ = (float *)_alloca((order) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *wt = (float *)_alloca((order) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *wt = (float *)_alloca((order) * sizeof(float));
  #else
...
void lspjmv_quantise(float *x, float *xq, int order) {
  int i, n1, n2, n3;
#ifdef _MSC_VER
  float *err = (float *)_alloca(order * sizeof(float));
  float *err2 = (float *)_alloca(order * sizeof(float));
  float *err3 = (float *)_alloca(order * sizeof(float));
  float *w = (float *)_alloca(order * sizeof(float));
  float *w2 = (float *)_alloca(order * sizeof(float));
  float *w3 = (float *)_alloca(order * sizeof(float));
#else
...
float speech_to_uq_lsps(float lsp[], float ak[], float Sn[], float w[],
  ...
  int i, roots;
  #ifdef _MSC_VER
  float *Wn = (float *)_alloca((m_pitch) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *Wn = (float *)_alloca((m_pitch) * sizeof(float));
  #else
  ...
  #endif
  #ifdef _MSC_VER
  float *R = (float *)_alloca((order + 1) * sizeof(float));
  #else
  #ifdef _MSC_VER
  float *R = (float *)_alloca((order + 1) * sizeof(float));
  #else
