...
const RIG_MODELS = {
  ...
  // budget and the ATU command variant (Optima uses AC103;).
  // FTX-1-specific caps: clarRx/clarTx/clarOffset (CF), monLevel (ML),
  // micGain (MG), compLevel (PL), dnrLevel (RL), breakIn (BI), breakInDelay
  ...
  'FTX-1 Field': {
    ...
    caps: {
      ...
      comp: true, compLevel: true, nr: true, nrLevel: false, anf: true,
      vox: true, voxLevel: true, agc: true, rit: true,
