...
const RIG_MODELS = {
  ...
  'IC-705': {
    ...
    caps: { nb: true, atu: true, vfo: true, filter: true, filterType: 'civ', rfgain: true, txpower: true, power: true, preamp: true, att: true, comp: true, nr: true, anf: true, vox: true, agc: true, nrLevel: true, nbLevel: true, voxLevel: true, mon: true, monLevel: true },
  ...
  'IC-706MKII': {
    ...
    // and the codec's 0x20 attenuator value doesn't match this rig's 0x14,
    // so att stays off until per-model overrides land.
    caps: { nb: true, atu: false, vfo: true, filter: true, filterType: 'civ', rfgain: false, txpower: false, power: false, preamp: true, att: false, comp: true, nr: false, anf: false, vox: true, agc: true },
  ...
  'IC-706MKIIG': {
    ...
    // as the MkII below — Preamp, Comp, VOX, AGC fast/slow all work. No
    // NR/ANF (pre-DSP). Attenuator uses 0x14 not 0x20 — stays off until
    // per-model codec overrides land.
    caps: { nb: true, atu: false, vfo: true, filter: true, filterType: 'civ', rfgain: false, txpower: false, power: false, preamp: true, att: false, comp: true, nr: false, anf: false, vox: true, agc: true },
    cw: { text: false, textChunk: 0, speed: false, paddleKey: false, dtrPins: null, taKey: false, breakIn: false },
    atuCmd: false, maxPower: 100,
  },
  'IC-7100': {
    ...
    caps: { nb: true, atu: false, vfo: true, filter: true, filterType: 'civ', rfgain: true, txpower: true, power: true, preamp: true, att: true, comp: true, nr: true, anf: true, vox: true, agc: true, nrLevel: true, nbLevel: true, voxLevel: true, mon: true, monLevel: true },
  ...
  'FLEX-6300': {
    ...
    caps: { nb: true, atu: true, vfo: false, filter: true, filterType: 'arbitrary', rfgain: true, txpower: true, power: false, preamp: false, att: false, comp: true, nr: true, anf: true, vox: true, agc: true, nrLevel: true, nbLevel: true, voxLevel: true, mon: true, monLevel: true },
