...
const RIG_MODELS = {
  ...
  'FT-710': {
    ...
    // FT-710 firmware rejects TX1; with "?;" but accepts MX1; for MOX TX.
    // Yaesu default would send TX1; — override per same Arch report.
    commands: { setTransmitOn: 'MX1;', setTransmitOff: 'MX0;' },
    ...
    notes: [
      ...
      '[FT-710] If commands are spuriously rejected with "?;", set the radio menu OPERATION SETTING -> GENERAL -> CAT-1 TIME OUT TIMER to 1000 ms (factory default 10 ms is too short for round-trip CAT).',
    ],
  },
  'FT-817/818': {
    brand: 'Yaesu', protocol: 'kenwood',
