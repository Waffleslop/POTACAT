...
const RIG_MODELS = {
  ...
  'FTX-1 Field': {
    ...
    // The Field's PC1xxx payload is not linear wattage in practice: hardware
    // testing saw PC1005 -> 9W and PC1015 -> 7W. Use a whole-watt dropdown
    // and an explicit raw-code map until the complete scale is verified.
