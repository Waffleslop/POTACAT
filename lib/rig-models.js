...
const RIG_MODELS = {
  ...
  'FTX-1 Field': {
    ...
    // Field hardware testing confirms only two reliable CAT power setpoints
    // for now: PC1005 -> 5W and PC1010 -> 10W. Keep the UI conservative
    // until Yaesu's full low-power CAT scale is better understood.
    powerChoices: [5, 10],
    powerMap: { 5: 5, 10: 10 },
